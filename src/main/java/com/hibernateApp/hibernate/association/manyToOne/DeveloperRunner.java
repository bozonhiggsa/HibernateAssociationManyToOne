package com.hibernateApp.hibernate.association.manyToOne;
...
public class DeveloperRunner {
    ...
    public static void main(String[] args) {
        ...
        Company company = developerRunner.addCompany("NetSite.com");

        System.out.println("Creating developer's records...");
        Integer developerId1 = developerRunner.addDeveloper("NetSite", "Developer", "Java Developer", 2, company);
